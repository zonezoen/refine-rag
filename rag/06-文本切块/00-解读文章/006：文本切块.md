...
> 本文是 [refine-rag](https://github.com/zonezoen/refine-rag) 系列教程的第7篇，我们来学习一下什么切块，应该怎么样去切块？
...
## 什么是切块？为什么要切块？
切块就是一篇长文切分一个小段一个小段来处理。

那为什么要切块的？有以下几点原因：
1. 大模型的上下文有 token 的长度限制
2. 切块可以突出表示某个向量的特征，如果说某个向量能表示10个特征，那么这个向量表达就会很模糊
3. 提升检索准确度，比如：检索一本书，有 1000多页，不可能 1000多页都是我想要的
