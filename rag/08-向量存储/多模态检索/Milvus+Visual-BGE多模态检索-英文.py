...
Installation:
-------------
1. Clone and install FlagEmbedding:
...
3. Download model weights:
   ...
   # Or download manually from https://huggingface.co/BAAI/bge-visualized-base-en-v1.5

For detailed installation instructions, see: 安装说明.md
"""
