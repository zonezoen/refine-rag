...
> 本文是 [refine-rag](https://github.com/zonezoen/refine-rag) 系列教程的第十三篇，我们来学习检索前处理的查询路由技术。
...
查询路由技术通过智能分发查询到最合适的数据源，显著提高 RAG 系统的效率和准确性：

1. 逻辑路由：准确但慢，适合明确分类
2. 语义路由：快速但略逊，适合模糊分类
3. 混合使用：结合两者优势，效果最佳

合理使用查询路由，可以大幅减少检索时间，提高准确率，降低系统成本。
